            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="breadcrums-block">
                    	 <ul class="breadcrumb">
                          <li><a href="#">Home</a></li>
                          <li class="is-active">Send Email</li>
                        </ul> 
                    </div>

                        <div class="new-registration-wrapper" style="height:250px;">
						    <!--<h1>New Register</h1>-->
...
<input type="text" class="form-control" id="contest_end_date" name="contest_end_date" placeholder="End Date" autocomplete="off">
               ...
               <input type="text" class="form-control" id="budget" name="budget" placeholder="Enter Contest Budget" autocomplete="off">
                ...
                <div class="footer">
                    <p>If you are facing issues, please send an email to <a href="mailto:ISIP@shobizexperience.com">ISIP@shobizexperience.com</a></p>
                </div>
            </div>
        </div>
    </div>
