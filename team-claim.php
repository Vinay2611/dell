...
$sql = "SELECT c.contest_id,c.po_id,c.contest_name,c.contest_type,c.start_date,c.end_date,c.status,c.budget,po.po_number,po.po_value,po.date_of_po,po.agency_fee,po.tax,po.balance_amount,wtsr.reward_amt,hr.hedge_rate FROM `contest` AS c JOIN purchase_order AS po ON c.po_id = po.po_id JOIN winner_tsr AS wtsr ON c.contest_id = wtsr.contest_id JOIN hedge_rate AS hr ON hr.hedge_id = po.hedge_id WHERE c.contest_id = '$_GET[cid]' GROUP BY c.contest_id";
                    ...
                    <!--<div class="form-group row">
                                ...
                                <!--<div class="form-group row">
                                    <div class="col-sm-offset-3 col-lg-9">
                                        <label class="radio radio-inline">Team outting
                                            <input type="radio" class="check" checked="checked" name="order_type" value="Team outting">
                                        </label>
                                        <label class="radio radio-inline">Refreshing
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="hidden" name="type" value="TeamClaim">
